...
public class Ejecutar extends Entorno{
    ...
    public void declaraFunciones(Entorno tablaDeSimbolos, ErrorImpresion errorImprmir) {       
        ...
        Simbolo si = new Simbolo("print", null, 0, 0, Operacion.tipoDato.CADENA, Simbolo.Rol.FUNCION);
        Simbolo si2 = new Simbolo("c", null, 0, 0, Operacion.tipoDato.VECTOR, Simbolo.Rol.FUNCION);
        Simbolo si3 = new Simbolo("typeof", null, 0, 0, Operacion.tipoDato.CADENA, Simbolo.Rol.FUNCION);
        Simbolo si4 = new Simbolo("stringlength", null, 0, 0, Operacion.tipoDato.ENTERO, Simbolo.Rol.FUNCION);
        Simbolo si5 = new Simbolo("ncol", null, 0, 0, Operacion.tipoDato.ENTERO, Simbolo.Rol.FUNCION);
        Simbolo si6 = new Simbolo("nrow", null, 0, 0, Operacion.tipoDato.ENTERO, Simbolo.Rol.FUNCION);
        Simbolo si7 = new Simbolo("length", null, 0, 0, Operacion.tipoDato.ENTERO, Simbolo.Rol.FUNCION);
        Simbolo si8 = new Simbolo("remove", null, 0, 0, Operacion.tipoDato.CADENA, Simbolo.Rol.FUNCION);
        Simbolo si9 = new Simbolo("tolowercase", null, 0, 0, Operacion.tipoDato.CADENA, Simbolo.Rol.FUNCION);
        Simbolo si10 = new Simbolo("touppercase", null, 0, 0, Operacion.tipoDato.CADENA, Simbolo.Rol.FUNCION);
        Simbolo si11 = new Simbolo("trunk", null, 0, 0, Operacion.tipoDato.DECIMAL, Simbolo.Rol.FUNCION);
        Simbolo si12 = new Simbolo("round", null, 0, 0, Operacion.tipoDato.DECIMAL, Simbolo.Rol.FUNCION);
