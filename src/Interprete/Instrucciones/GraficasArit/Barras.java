        ...
        try { //barplot( H, xlab, ylab, main, names.arg)
            if (parametro instanceof Comas) {
                ...
                if (!tipoH.equals(Operacion.tipoDato.VECTOR) && !tipoH.equals(Operacion.tipoDato.ENTERO)
                    ...
                    listas.errores.add(new NodoError(getLinea(), getColumna(), NodoError.tipoError.Semantico,
                            "Parametro H no valido para la grafica Pie, debe ser Numerico, y es: " + String.valueOf(tipoH)));
                    return Operacion.tipoDato.ERRORSEMANTICO;
                } else {
                    if (tipoH.equals(Operacion.tipoDato.VECTOR)) {
                        ...
                        if (tipoV1.equals(Operacion.tipoDato.ERRORSEMANTICO)) {
                            listas.errores.add(new NodoError(getLinea(), getColumna(), NodoError.tipoError.Semantico,
                                    "El tipo del parametro H no es valido para realizar la Grafica Pie"));
                            return Operacion.tipoDato.ERRORSEMANTICO;
                        }
                        ...
                        if (!tipoH.equals(Operacion.tipoDato.ENTERO) && !tipoH.equals(Operacion.tipoDato.DECIMAL)) {
                            listas.errores.add(new NodoError(getLinea(), getColumna(), NodoError.tipoError.Semantico,
                                    "El tipo del parametro H no es valida para realizar la Grafica Pie es de tipo: " + tipoH));
                            return Operacion.tipoDato.ERRORSEMANTICO;
                        }
                    } else {
                ...
                if (!tipoxLab.equals(Operacion.tipoDato.VECTOR) && !tipoxLab.equals(Operacion.tipoDato.STRING)) {
                    listas.errores.add(new NodoError(getLinea(), getColumna(), NodoError.tipoError.Semantico,
                            "Parametro xLab no valido para la grafica Pie, debe ser String, y es: " + String.valueOf(tipoxLab)));
                    return Operacion.tipoDato.ERRORSEMANTICO;
                } else {
                    if (tipoxLab.equals(Operacion.tipoDato.VECTOR)) {
                        ...
                        if (tipoV1.equals(Operacion.tipoDato.ERRORSEMANTICO)) {
                            listas.errores.add(new NodoError(getLinea(), getColumna(), NodoError.tipoError.Semantico,
                                    "El tipo del parametro xLab no es valida para realizar la Grafica Pie"));
                            return Operacion.tipoDato.ERRORSEMANTICO;
                        }
                        ...
                        if (!tipoxLab.equals(Operacion.tipoDato.STRING)) {
                            listas.errores.add(new NodoError(getLinea(), getColumna(), NodoError.tipoError.Semantico,
                                    "El tipo del parametro xLab no es valida para realizar la Grafica Pie es de tipo: " + tipoxLab));
                            return Operacion.tipoDato.ERRORSEMANTICO;
                        }
                    } else {
                ...
                if (!tipoyLab.equals(Operacion.tipoDato.VECTOR) && !tipoyLab.equals(Operacion.tipoDato.STRING)) {
                    listas.errores.add(new NodoError(getLinea(), getColumna(), NodoError.tipoError.Semantico,
                            "Parametro yLab no valido para la grafica Pie, debe ser Numerico, y es: " + String.valueOf(tipoyLab)));
                    return Operacion.tipoDato.ERRORSEMANTICO;
                } else {
                    if (tipoyLab.equals(Operacion.tipoDato.VECTOR)) {
                        ...
                        if (tipoV1.equals(Operacion.tipoDato.ERRORSEMANTICO)) {
                            listas.errores.add(new NodoError(getLinea(), getColumna(), NodoError.tipoError.Semantico,
                                    "El tipo del parametro yLab no es valido para realizar la Grafica Pie"));
                            return Operacion.tipoDato.ERRORSEMANTICO;
                        }
                        ...
                        if (!tipoyLab.equals(Operacion.tipoDato.ENTERO) && !tipoyLab.equals(Operacion.tipoDato.DECIMAL)) {
                            listas.errores.add(new NodoError(getLinea(), getColumna(), NodoError.tipoError.Semantico,
                                    "El tipo del parametro yLab no es valida para realizar la Grafica Pie es de tipo: " + tipoyLab));
                            return Operacion.tipoDato.ERRORSEMANTICO;
                        }
                    } else {
                ...
                if (!tipoNames.equals(Operacion.tipoDato.VECTOR) && !tipoNames.equals(Operacion.tipoDato.STRING)) {
                    listas.errores.add(new NodoError(getLinea(), getColumna(), NodoError.tipoError.Semantico,
                            "Parametro names no valido para la grafica Pie, debe ser String, y es: " + String.valueOf(tipoNames)));
                    return Operacion.tipoDato.ERRORSEMANTICO;
                } else {
                    if (tipoNames.equals(Operacion.tipoDato.VECTOR)) {
                        ...
                        if (tipoV1.equals(Operacion.tipoDato.ERRORSEMANTICO)) {
                            listas.errores.add(new NodoError(getLinea(), getColumna(), NodoError.tipoError.Semantico,
                                    "El tipo del parametro names no es valido para realizar la Grafica Pie"));
                            return Operacion.tipoDato.ERRORSEMANTICO;
                        }
                        ...
                        if (!tipoNames.equals(Operacion.tipoDato.STRING)) {
                            listas.errores.add(new NodoError(getLinea(), getColumna(), NodoError.tipoError.Semantico,
                                    "El tipo del parametro names no es valida para realizar la Grafica Pie es de tipo: " + tipoNames));
                            return Operacion.tipoDato.ERRORSEMANTICO;
                        }
                    } else {
