 ...
 * @author sharolin
 */
public class ACorcheteEcoma extends Operacion implements Instruccion {

    //id acorchete E coma ccorchete igual E{::}
    private String idMatriz;
    private Expresion indiceFila;
    private Expresion valorAsignar;
    private int linea;
    private int columna;

    public ACorcheteEcoma() {
    }

    public ACorcheteEcoma(String idMatriz, Expresion indiceFila, Expresion valorAsignar, int linea, int columna) {
    ...
    public Object ejecutar(Entorno tablaDeSimbolos, ErrorImpresion listas) {
        try {
            ...
            Expresion tuex = indiceFila;
            if (indiceFila instanceof Comas) {
                listas.errores.add(new NodoError(getLinea(), getColumna(), NodoError.tipoError.Semantico,
            ...
            if (tipoLaFila.equals(Operacion.tipoDato.ENTERO) || tipoLaFila.equals(Operacion.tipoDato.VECTOR)) {
                ...
                if (tipoLaFila.equals(Operacion.tipoDato.VECTOR)) {
                    ...
                    if (tipoV1.equals(Operacion.tipoDato.ERRORSEMANTICO)) {
                        listas.errores.add(new NodoError(getLinea(), getColumna(), NodoError.tipoError.Semantico,
                                "El tipo de la Expreion para Acceder a la fila no es valida para la Matriz: " + getIdMatriz()
                ...
                for (int i = 0; i < arree.size(); i++) {
                    ...
                    ArrayList<Object> columnaV = (ArrayList<Object>) arree.get(i);
                ...
                listas.errores.add(new NodoError(getLinea(), getColumna(), NodoError.tipoError.Semantico,
                        "Parametro no es tipo Entero, por tanto no es valido para acceder a las filas de una matriz"));
                return Operacion.tipoDato.ERRORSEMANTICO;
            }

        } catch (Exception e) {
            System.out.println("Error en la clase ACorcheteEcoma Ejecutar()");
            listas.errores.add(new NodoError(getLinea(), getColumna(), NodoError.tipoError.Semantico,
     ...
     */
    public Expresion getIndiceFila() {
        return indiceFila;
    }
     ...
     */
    public void setIndiceFila(Expresion indiceFila) {
        this.indiceFila = indiceFila;
    }
