 ...
 * @author sharolin
 */
public class Or extends Operacion implements Expresion{
    ...
    public Object getValue(Entorno tablaDeSimbolos, ErrorImpresion listas) {
        ...
        //varios con varios solo si es del mismo tamanio //si es solo de uno tiene que ser OR a VECTOR el tipo
        ...
        try {
            ...
            if ((tipo1.equals(Operacion.tipoDato.VECTOR) || tipo1.equals(Operacion.tipoDato.BOOLEAN)
                ...
                if (tipo1.equals(Operacion.tipoDato.VECTOR)) {
                    ...
                    if (tipoV1.equals(Operacion.tipoDato.ERRORSEMANTICO)) {
                        listas.errores.add(new NodoError(getLinea(), getColumna(), NodoError.tipoError.Semantico,
                                "El tipo de la Expreion 1 no es valida para realizar la OR"));
                ...
                Operacion.tipoDato tipoResultanteLOGICAS = this.tipoResultanteLOGICAS(tipo1, tipo2, tablaDeSimbolos, listas);
                if (normal.size() == 1 && normal2.size() == 1) {//--------------------------------------------------------------------
                    ...
                    switch (tipoResultanteLOGICAS) {
                        case BOOLEAN:
                            vectorParaDevolver.add(Boolean.parseBoolean(String.valueOf(ob)) || Boolean.parseBoolean(String.valueOf(ob2)));
                            return vectorParaDevolver;

                        default:
                            listas.errores.add(new NodoError(getLinea(), getColumna(), NodoError.tipoError.Semantico,
                                    "Tipos no validos para realizar la OR Tipo Exp1: " + String.valueOf(tipo1)
                    ...
                    switch (tipoResultanteLOGICAS) {
                        case BOOLEAN:
                            for (int i = 0; i < normal.size(); i++) {
                                ...
                                item.add(Boolean.parseBoolean(String.valueOf(ob)) || Boolean.parseBoolean(String.valueOf(ob2)));
                ...
                listas.errores.add(new NodoError(this.getLinea(), this.getColumna(), NodoError.tipoError.Semantico, "Tipo de datos EXP1: "
                        + String.valueOf(tipo1) + " EXP2: " + String.valueOf(tipo2) + "No son validos para operarse como OR entre si"));
                return Operacion.tipoDato.ERRORSEMANTICO;
            }
        } catch (Exception e) {
            System.out.println("Error en la clase OR en la linea/Columna: "
    ...
    public Operacion.tipoDato getType(Entorno tablaDeSimbolos, ErrorImpresion listas) {
        ...
        try {
            ...
            if ((tipo1.equals(Operacion.tipoDato.VECTOR) || tipo1.equals(Operacion.tipoDato.BOOLEAN)
                ...
                Operacion.tipoDato ti = this.tipoResultanteLOGICAS(tipo1, tipo2, tablaDeSimbolos, listas);
                if (ti.equals(Operacion.tipoDato.BOOLEAN)) {
            ...
            System.out.println("Error en la clase OR en el getType()");
            return Operacion.tipoDato.ERRORSEMANTICO;
        }
    }
}
