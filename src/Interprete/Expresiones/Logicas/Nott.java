...
public class Nott extends Operacion implements Expresion {
    ...
    public Object getValue(Entorno tablaDeSimbolos, ErrorImpresion listas) {
        ...
        //varios con varios solo si es del mismo tamanio //si es solo de uno tiene que ser NOT a VECTOR el tipo
        ...
        try {
            ...
            if (tipo1.equals(Operacion.tipoDato.VECTOR) || tipo1.equals(Operacion.tipoDato.BOOLEAN)
                ...
                if (tipo1.equals(Operacion.tipoDato.VECTOR)) {
                    ...
                    if (tipoV1.equals(Operacion.tipoDato.ERRORSEMANTICO)) {
                        listas.errores.add(new NodoError(getLinea(), getColumna(), NodoError.tipoError.Semantico,
                                "El tipo de la Expreion 1 no es valida para realizar la NOT"));
                ...
                if (normal.size() == 1) {//--------------------------------------------------------------------
                    ...
                    switch (tipo1) {
                        case BOOLEAN:
                            vectorParaDevolver.add(!Boolean.parseBoolean(String.valueOf(ob)));
                            return vectorParaDevolver;

                        default:
                            listas.errores.add(new NodoError(getLinea(), getColumna(), NodoError.tipoError.Semantico,
                                    "Tipos no validos para realizar la NOT Tipo Exp1: " + String.valueOf(tipo1)));
                            return Operacion.tipoDato.ERRORSEMANTICO;
                    }
                    ...
                    switch (tipo1) {
                        case BOOLEAN:
                            for (int i = 0; i < normal.size(); i++) {
                                ...
                                item.add(!Boolean.parseBoolean(String.valueOf(ob)));
                ...
                listas.errores.add(new NodoError(this.getLinea(), this.getColumna(), NodoError.tipoError.Semantico, "Tipo de datos EXP1: "
                        + String.valueOf(tipo1) + "No es valido para operarse como NOT "));
                return Operacion.tipoDato.ERRORSEMANTICO;
            }
        } catch (Exception e) {
            System.out.println("Error en la clase NOT en la linea/Columna: "
    ...
    public Operacion.tipoDato getType(Entorno tablaDeSimbolos, ErrorImpresion listas) {
        ...
        try {
            ...
            if (tipo1.equals(Operacion.tipoDato.VECTOR) || tipo1.equals(Operacion.tipoDato.BOOLEAN)
                ...
                listas.errores.add(new NodoError(this.getLinea(), this.getColumna(), NodoError.tipoError.Semantico, "Tipo de datos EXP1: "
                        + String.valueOf(tipo1) + "No es valido para operarse como NOT entre si"));
                return Operacion.tipoDato.ERRORSEMANTICO;
            }
        } catch (Exception e) {
            System.out.println("Error en la clase NOT en el getType()");
            return Operacion.tipoDato.ERRORSEMANTICO;
        }
    }
}
