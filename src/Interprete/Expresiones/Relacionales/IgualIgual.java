 ...
 * @author sharolin
 */
public class IgualIgual extends Operacion implements Expresion {

    public IgualIgual(int linea, int columna, Expresion expresion1, Expresion expresion2) {
            ...
            if ((tipo1.equals(Operacion.tipoDato.VECTOR) || tipo1.equals(Operacion.tipoDato.BOOLEAN)
                ...
                if (tipo1.equals(Operacion.tipoDato.VECTOR)) {
                    ...
                    if (tipoV1.equals(Operacion.tipoDato.ERRORSEMANTICO)) {
                        listas.errores.add(new NodoError(getLinea(), getColumna(), NodoError.tipoError.Semantico,
                                "El tipo de la Expreion 1 no es valida para realizar la IGUALDAD"));
                ...
                if (normal.size() == 1 && normal2.size() == 1) {//--------------------------------------------------------------------
                    ...
                    switch (tipoResultanteRELACIONALES) {
                        ...
                        default:
                            listas.errores.add(new NodoError(getLinea(), getColumna(), NodoError.tipoError.Semantico,
                                    "Tipos no validos para realizar la IGUALDAD Tipo Exp1: " + String.valueOf(tipo1)
                ...
                listas.errores.add(new NodoError(this.getLinea(), this.getColumna(), NodoError.tipoError.Semantico, "Tipo de datos EXP1: "
                        + String.valueOf(tipo1) + " EXP2: " + String.valueOf(tipo2) + "No son validos para operarse como IGUALDAD entre si"));
                return Operacion.tipoDato.ERRORSEMANTICO;
            }
        } catch (Exception e) {
            System.out.println("Error en la clase IGUALDAD en la linea/Columna: "
    ...
    public Operacion.tipoDato getType(Entorno tablaDeSimbolos, ErrorImpresion listas) {
        ...
        try {
            ...
            System.out.println("Error en la clase IGUALDAD en el getType()");
            return Operacion.tipoDato.ERRORSEMANTICO;
        }
    }
