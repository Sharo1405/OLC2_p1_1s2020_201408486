...
public class nRow implements Expresion {
    ...
    public nRow(Expresion exp, int linea, int columna) {
        this.exp = exp;
        this.linea = linea;
        ...
        try {
            ...
            if (obDevuelto instanceof Simbolo) {
                ...
                if (existente.getTipo().equals(Operacion.tipoDato.MATRIZ)) {
                    ...
                    ArrayList<Object> vectorfila =(ArrayList<Object>) nev2.get(0);
                    int contadorFilas = 0;
                    for (Object object : vectorfila) {
                        contadorFilas++;
                    }
                    nev.add(contadorFilas);
                    return nev;
                ...
                if (tipo.equals(Operacion.tipoDato.MATRIZ)) {
                    ...
                    ArrayList<Object> vectorfila =(ArrayList<Object>) xpxp.get(0);
                    ArrayList<Object> nev = new ArrayList<>();
                    int contadorFilas = 0;
                    for (Object object : vectorfila) {
                        contadorFilas++;
