 ...
 * @author sharolin
 */
public class Negativo extends Operacion implements Expresion {

    public Negativo(int linea, int columna, Expresion expresion1) {
            ...
            if (tipo1.equals(Operacion.tipoDato.VECTOR) || tipo1.equals(Operacion.tipoDato.BOOLEAN)
                ...
                if (tipo1.equals(Operacion.tipoDato.VECTOR)) {
                    ...
                    if (tipoV1.equals(Operacion.tipoDato.ERRORSEMANTICO)) {
                        listas.errores.add(new NodoError(getLinea(), getColumna(), NodoError.tipoError.Semantico,
                                "El tipo de la Expreion 1 no es valida para realizar la NEGATIVO"));
                ...
                if (normal.size() == 1) {//--------------------------------------------------------------------
                    ...
                    switch (tipo1) {
                        ...
                        default:
                            listas.errores.add(new NodoError(getLinea(), getColumna(), NodoError.tipoError.Semantico,
                                    "Tipos no validos para realizar la NEGATIVO Tipo Exp1: " + String.valueOf(tipo1)));
                            return Operacion.tipoDato.ERRORSEMANTICO;
                    }
                ...
                listas.errores.add(new NodoError(this.getLinea(), this.getColumna(), NodoError.tipoError.Semantico, "Tipo de datos EXP1: "
                        + String.valueOf(tipo1) + "No son validos para operarse como NEGATIVO entre si"));
                return Operacion.tipoDato.ERRORSEMANTICO;
            }
        } catch (Exception e) {
            System.out.println("Error en la clase NEGATIVO en la linea/Columna: "
    ...
    public Operacion.tipoDato getType(Entorno tablaDeSimbolos, ErrorImpresion listas) {
        ...
        try {
            ...
            if (tipo1.equals(Operacion.tipoDato.VECTOR) || tipo1.equals(Operacion.tipoDato.BOOLEAN)
                ...
                listas.errores.add(new NodoError(this.getLinea(), this.getColumna(), NodoError.tipoError.Semantico, "Tipo de datos EXP1: "
                        + String.valueOf(tipo1) + "No es valido para operarse como NEGATIVO entre si"));
                return Operacion.tipoDato.ERRORSEMANTICO;
            }
        } catch (Exception e) {
            System.out.println("Error en la clase NEGATIVO en el getType()");
            return Operacion.tipoDato.ERRORSEMANTICO;
        }
    }
}
